...
export const setup = async (
	...
	// 0: have 3 accounts admin, user and helper
	// 1: deploy token A and B
	// 2: generate or just have constant key pair
	// 3: deploy Batcher contract
	// 4: deploy mock AMM contract for swap
	//
	// const receipt = await BatcherVaultContract.deploy(
	// 	deployer,
	// 	game_id,
	// 	player1.getAddress()
	// )
